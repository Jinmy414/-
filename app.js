...
function renderHome() {
  ...
  <section id="discover" class="discover-section"><div class="section-heading"><div><span class="section-index">01 / 今日记录</span><h2>先从一部作品开始</h2><p>每次打开，遇见 3 部热门高分和 3 部冷门高分作品。</p></div><span class="text-link section-date">随机漫游中 · ${new Date().toLocaleDateString('zh-CN', { month: 'long', day: 'numeric' })}</span></div>
    <div class="split-heading"><h2>热门高分</h2><span class="line"></span></div><div class="feature-grid">${popular.length ? popular.map(work => workCard(work, true)).join('') : '<div class="empty-state">还没有足够的热门高分作品。</div>'}</div>
    <div class="split-heading"><h2>冷门高分</h2><span class="line"></span></div><div class="feature-grid">${niche.length ? niche.map(work => workCard(work, true)).join('') : '<div class="empty-state">再留下几份评分，这里会长出新的推荐。</div>'}</div>
  </section>
